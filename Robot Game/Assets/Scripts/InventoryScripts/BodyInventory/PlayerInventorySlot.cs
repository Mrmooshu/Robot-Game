...
public class PlayerInventorySlot : MonoBehaviour, IDropHandler, ISlot
{
    ...
    {
        BodyInventory.Move(inventoryItem.parent.parent.parent.GetComponentInParent<BodyInventoryDisplay>().currentInventory, transform.parent.parent.parent.GetComponentInParent<BodyInventoryDisplay>().currentInventory, inventoryItem.parent.GetComponent<PlayerInventorySlot>().inventoryIndex, inventoryIndex);
